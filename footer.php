...
?>
            ...
            <!-- Footer Bottom -->
            <div class="footer-bottom bg-grey-1">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <!-- Copyright Area -->
                            <div class="copyright-area d-flex flex-wrap justify-content-center justify-content-sm-between text-center py-4">
                                ...
                                <!-- Copyright Right -->
                                <div class="copyright-right">All right Reserved  <i class=""></i>  <a href="https://www.facebook.com/freshgreengroup">FG Group Holding</a></div>
                            </div>
                        </div>
                    </div>
                </div>
